...
async def agregar_expediente_post(
    ...
    session: Session = Depends(get_session)
        ...
        if parte1 == "duplicado":
            ...
            try:
                destinatario = "nidia@9deJulio.gov.ar"
                asunto = f"Expediente actualizado N° {nuevo_expediente.nroExpedienteMesaEntrada}/{nuevo_expediente.anioMesaEntrada}"
                mensaje = f"""
                Se actualizó el expediente N° {nuevo_expediente.nroExpedienteMesaEntrada}/{nuevo_expediente.anioMesaEntrada}.
                Observaciones: {'Fue ingresado a las oficinas de Obras Particulares para su proceso'}.
                """
